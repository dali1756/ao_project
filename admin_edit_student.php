...
<div class="col-12 btn-back"><a href="new-member2.php" ><i class="fas fa-chevron-circle-left fa-3x"></i><label class='previous'></label></a></div>
	...
	<div class="col-12 row container-fluid mar-bot50">
	<?php if($_GET[success]){ ?>
		...
		<div class="container">
			<div class="row">
				<div class="col-12">
					...
					<form id='mform' action="model/user_upd.php" method="post">
						<div class="form-group row">
							<label for="exampleFormControlInput1" class="col-sm-2 col-form-label label-right">您的舊密碼</label>
    						<div class="col-sm-9"> 
								<input  type="password" required='required' class="form-control  col" name="o_pwd" id="o_pwd" inputmode="numeric" pattern="[0-9]{4,8}" title="請輸入4~8碼純數字">
    						</div>
						</div>
  						...
  						<div class="form-group row">
    						...
    						<div class="col-sm-9">
								  <input type="password" required='required' class="form-control" name="new_pwd" id="new_pwd"  title="請輸入4~8碼純數字"  placeholder="請輸入4~8碼純數字" inputmode="numeric" pattern="[0-9]{4,8}">  
    						</div>
						</div>
						...
						<div class="form-group row">
    						...
    						<div class="col-sm-9">
								  <input type="password" required='required' class="form-control" name="new_pwd_check" id="new_pwd_check"  title="請輸入4~8碼純數字"  placeholder="請輸入4~8碼純數字" inputmode="numeric" pattern="[0-9]{4,8}">  
    						</div>
						</div><br><br>
