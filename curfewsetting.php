...
<section id="main" class="wrapper">
	...
	<div class="inner">       
		<div class="row"> 
			...
			<!-- 改成圖示 ICON-->
			<div class="col-lg-3 col-6 p-4 text-center"> 
				<a  href="curfew-addschedule.php">
				<img class="mb-3" src="img/29新增排程.png">
				<h4>新增排程</h4> </a> 
			</div>
			<div class="col-lg-3 col-6 p-4 text-center"> 
				<a  href="curfew-editschedule.php">
				<img class="mb-3" src="img/30排程編輯.png">
				<h4>排程編輯</h4> </a> 
			</div>
			<div class="col-lg-3 col-6 p-4 text-center">
				<a  href="curfew-bindingschedule.php">
				<img class="mb-3" src="img/31門禁排程.png">
				<h4>門禁排程</h4> </a> 
			</div>
			<div class="col-lg-3 col-6 p-4 text-center">
				<a  href="curfew-bindinglift.php">
				<img class="mb-3" src="img/31門禁排程.png">
				<h4>電梯排程</h4> </a> 
			</div>
