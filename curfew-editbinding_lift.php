<?php 
	...
	$id  = $_GET['id'];
	$sql = "SELECT * FROM `elevator_hardware` WHERE id = '{$id}'";
	...
	if($data == '') {
		...
		echo "<script>location.replace('curfew-bindinglift.php?error=2')</script>";
		exit;
	}
...
<section id="main" class="wrapper">
	<div class='col-12 btn-back'><a href='curfew-bindinglift.php' ><i class="fas fa-chevron-circle-left fa-3x"></i><label class='previous'></label></a></div>

	<div class="rwd-box"></div><br><br>
	<div class="container" style="text-align: center;">
		<h1 class="jumbotron-heading text-center">電梯排程編輯：<?php echo $data['elevator_name'] ?></h1>
    </div>
	...
	<div class="inner">
	<!--編輯-->
	<form id='mform1' action="model/elevator_upd.php" method="post" class='col-12'>
	<div class="row">
					...
					<div class='col-12'>
							 ...
							 <label for='exampleFormControlInput1' class='col-sm-2 col-form-label label-right'>電梯名稱</label>
							 <div class='col-sm-9'> 
								 <input  type='text' maxlength='20' class='form-control' name='door_name' value='<?php echo $data['elevator_name'] ?>'>
							 </div>
							 </div>
