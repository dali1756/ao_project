<?php 
	...
	if($username) { $sql_kw .= " AND `name` IN (SELECT room_strings FROM member 
	...
	if($id_card)  { $sql_kw .= " AND `name` IN (SELECT room_strings FROM member WHERE `id_card` LIKE '%".trim($id_card)."%') "; } // 可試著將 LIKE 和 = 交換使用
...
<section id="main" class="wrapper">
	...
	<div class="inner">
		<div class="row">
				...
				<form id='mform1' action="testnowsystem.php" method="get" class='col-12'>
					<div class='col-12'>
                          ...
                          <div class="card card-h mb-4 card-green text-green fz-18 h-auto">
                            <div class="py-3 nowsystem">
								<ul>
									...
									<li>
										收費設定(110V)/費率：<span class='' style="color:#24D354"><?php echo $mode ?><span>/<?php echo $rate ?>
									</li>
									<li>
										收費設定(220V)/費率：<span class='' style="color:#24D354"><?php echo $mode_220 ?><span>/<?php echo $rate_220 ?>
									</li>
