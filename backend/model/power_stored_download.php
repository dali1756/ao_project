<?php
	...
	$sql = "SELECT e.*, m.username, m.cname, r.`name`, m.balance, m.berth_number 
	...
	if($data) {
		...
		$body_head = array("編號", "付款日期", "姓名/卡號/學號", "房號/床號", "狀態", "儲值/退款後餘額", "BeforeValue", "PayValue", "SavedValue");
		...
		header('Location: ../power-storedvalue.php?error=1');
	}
?>