 ...
 <section id="main" class="wrapper">
	...
	<div class="container">
			...
			<div class=" text-right ">
				<!-- <button type="button" class="btn btn-loginfont btn-primary2 col-sm-2 offset-sm-10 mb-3" onclick='exportExcel()' ><?php echo $lang->line("index.export") ?></button> -->
				<button type="button" class="btn btn-loginfont btn-primary2 col-sm-2 offset-sm-10 mb-3" data-toggle="modal" data-target="#exportModal"><?php echo $lang->line("index.export") ?></button>
			</div>
			...
			<div id="power-total" class="col-12 alert alert-info text-green">
				...
				<!--新増使用度數資料 -->
				小計用電(110V)：<?php echo $room_total_ele_110 ?><br>
				小計用電(220V)：<?php echo $room_total_ele_220 ?><br>
			</div>
			<div class="row">
				<?php echo $inner_html; ?>
			</div>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exportModalLabel">檔案匯出中,請稍候</h5>
      </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-primary2" data-dismiss="modal">取消</button>
      </div>
    </div>
  </div>
</div>
...
function export2excel1() {
	var dong=$('[name="m_dong"]').val();
		...
		location.replace("model/power-consumption-m_report.php?dong="+
		dong+"&year_st="+year_st+"&month_st="+month_st+"&dong_name="+dong_name+"&total="+total+"&total_1="+total_1+"&total_2="+total_2);
}
</script>
